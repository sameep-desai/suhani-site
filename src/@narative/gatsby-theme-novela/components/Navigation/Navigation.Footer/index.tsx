      ...
      <Section narrow>
        ...
        <FooterContainer>
          <FooterText>
            © {copyrightDate} {name}
            <div>
            <p style={{opacity: "0.7", fontSize: "1.5rem"}}>Suhani constructions, Sunetra Apartments, <br></br>
            Nr-Thakre Garden, Badlapur East, Dist: Thane, MAH, PIN 421503
            <br/>Phone: +91 9850501916</p>
          </div>
          </FooterText>
          <div>
